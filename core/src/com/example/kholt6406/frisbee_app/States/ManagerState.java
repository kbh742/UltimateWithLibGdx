...
public class ManagerState extends State {
    ...
    int[] positions = {1200, 150, 200, 500, 560, 500, 920, 500, 400, 200, 740, 200, 1240, 485};
    int drawCounter = 0;
    ...
    public ManagerState(GameStateManager gsm) {
        ...
        playerBtn2.setBounds(positions[4], positions[5], playerBtn2.getWidth(), playerBtn2.getHeight());  //tells the button where to go
        ...
        playerBtn3.setBounds(positions[6], positions[7], playerBtn3.getWidth(), playerBtn3.getHeight());  //tells the button where to go
        ...
        playerBtn4.setBounds(positions[8], positions[9], playerBtn4.getWidth(), playerBtn4.getHeight());  //tells the button where to go
        ...
        playerBtn5.setBounds(positions[10], positions[11], playerBtn5.getWidth(), playerBtn5.getHeight());  //tells the button where to go
    ...
    protected void render(SpriteBatch sb) {
        ...
        sb.draw(playerCard, positions[0], positions[1]);
        sb.draw(playerFrame, positions[2], positions[3]);
        sb.draw(playerFrame, positions[4], positions[5]);
        sb.draw(playerFrame, positions[6], positions[7]);
        sb.draw(playerFrame, positions[8], positions[9]);
        sb.draw(playerFrame, positions[10], positions[11]);
        ...
        if(selected >= 0){
            sb.draw(playerSelected, positions[(selected+1)*2]-10, positions[(selected+1)*2+1]-10);
            Texture playerPreview = new Texture("player_portrait_" + (selected+1) + ".png");
            sb.draw(playerPreview, positions[12], positions[13]);
        }
        /*try {
            Thread.sleep(1000);
